...
def large_scale(
    ...
    postera: bool = False,
    postera_molset_name: str | None = None,
...
def ligand_transfer_docking(
    ref_structure_dir: str | None = None,
    ref_pdb_file: str | None = None,
    ref_fragalysis_dir: str | None = None,
    pdb_file: str | None = None,
    fragalysis_dir: str | None = None,
    structure_dir: str | None = None,
    posit_confidence_cutoff: float = 0.1,
    ...
    md_steps: int = 2500000,  # 10 ns @ 4.0 fs timestep
    md_openmm_platform: OpenMMPlatform = OpenMMPlatform.Fastest,
    ref_chain: str | None = "A",
    active_site_chain: str | None = "A",
